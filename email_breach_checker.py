...
# -------------------- Configuration --------------------
API_KEY = '5b7792f17a6a423cbfc29684081c716c'
...
def main():
    ...
    if selected_file and selected_file.exists():
        ...
        if emails:
            print(Fore.BLUE + f"Found {len(emails)} valid email(s). Starting scan...")
            scan_emails(emails)
        else:
            print(Fore.RED + "No valid emails found in that file.")
    else:
